<template>
  ...
  >
    ...
    <vxe-column field="name" title="名称" :title-help="{ message: '自定义帮助提示信息' }" />
    <vxe-column
      field="role"
      title="角色"
    ...
    <vxe-column field="address" title="Address" width="160" />
    <vxe-column type="html" field="content" title="Content" width="200" />
  </vxe-table>
</template>
